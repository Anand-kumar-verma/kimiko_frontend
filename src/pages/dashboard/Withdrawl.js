      ...
      >
        ...
        >
          ...
          <Stack direction="row" sx={{ alignItems: "center", mt: "10px" }}>
            <span className="!text-white !text-[20px] !font-semibold">Game Wallet: </span> 
            <Typography
              variant="body1"
              color="initial"
              sx={{
          ...
          >
            ...
            <Box mt={2} component="form" onSubmit={fk.handleSubmit}>
              ...
              <FormControl fullWidth sx={{ mt: "10px" }}>
                <Stack direction="row" className="loginlabel">
                  <Typography variant="h3" sx={{ color: 'white' }}>
                    Withdrawal Type <span style={{ color: 'white' }}>*</span>
                  </Typography>
                </Stack>
                <TextField
                  select
                ...
                >
                  <MenuItem value={"Withdrawl Type"}>Withdrawal Type</MenuItem>
                  <MenuItem value={"main_withdrawl"}>Main Withdrawal</MenuItem>
                  <MenuItem value={"game_withdrawl"}>Game Withdrawal</MenuItem>
                </TextField>
              </FormControl>
        ...
        <Box className="w95" sx={{ background: kidarkgreen, padding: 1, borderRadius: '10px', mb: 5, }}>
          ...
          >
            <p className="  !text-green-600 !m-1">
              ⭐️ Withdrawal Timing: Mon to Fri (10 AM to 6 PM)
              {" "}
            </p>
            <p className="  !text-green-600 !m-1">
              ⭐️ Arrival in 2 - 36 Hrs
              {" "}
            </p>
            <p className="  !text-green-600 !m-1">
              ⭐️ Withdrawal Charge: 5%
              {" "}
            </p>
            <p className="  !text-green-600 !m-1">
              ⭐️ Minimum Withdrawal: 199/-
              {" "}
            </p>
            <p className="  !text-green-600 !m-1">
          ...
          <div className="!p-5 !max-w-[300px]">
            <p className="!font-bold text-center flex-col">
              <span className="!text-lg">
                Your withdrawal amount will be add in your bank account within 24
                Hrs.
              </span>
