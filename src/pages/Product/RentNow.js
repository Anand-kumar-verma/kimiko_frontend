  ...
  return (
    <Layout>
      ...
      >
        ...
        <Box sx={{ width: '95%', ml: '2.5%', mb: 5, mt: 2, }}>
        ...
        <div className="p-4 mb-20">
          <div className="grid grid-cols-1 gap-5 ">
            {products?.map((product, index) => (
              <div key={product?.m_pack_id} className="bg-white border flex justify-between p-5 border-gray-200 rounded-lg overflow-hidden shadow-lg">
                <img
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-600 font-semibold "> Status :  <span className='!font-bold !text-red-600 '>  {product?.tr_status || 0}</span> </p>
                  <p className="text-gray-600 font-semibold ">Date: <span className='!font-bold !text-black'>  {product?.tr_date || 0}</span> </p>
                  <p className="text-gray-600 font-semibold ">Daily income : <span className='!font-bold !text-black'> ₹ {product?.tr_roi_income || 0}</span> </p>
                  <p className="text-gray-600 font-semibold ">Days : <span className='!font-bold !text-black'> {product?.tr_days || 0}</span> </p>
